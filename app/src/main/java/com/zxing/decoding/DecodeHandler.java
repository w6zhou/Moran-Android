...
import com.tablet.moran.activity.BaseCameraActivity;
...
final class DecodeHandler extends Handler {
  ...
  DecodeHandler(BaseCameraActivity activity, Hashtable<DecodeHintType, Object> hints, CameraManager cameraManager) {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    if (rawResult != null && rawResult.toString().contains("&")) {
